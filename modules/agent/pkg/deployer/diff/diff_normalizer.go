...
import (
	...
	"github.com/rancher/fleet/modules/agent/pkg/deployer/diff/glob"
...
func NewIgnoreNormalizer(ignore []resource.ResourceIgnoreDifferences, overrides map[string]resource.ResourceOverride) (Normalizer, error) {
