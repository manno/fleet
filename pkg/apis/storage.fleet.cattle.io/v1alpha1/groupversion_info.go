...
// Package v1alpha1 contains API Schema definitions for the storage.fleet.cattle.io v1alpha1 API group
// +kubebuilder:object:generate=true
// +groupName=storage.fleet.cattle.io
package v1alpha1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "storage.fleet.cattle.io", Version: "v1alpha1"}
