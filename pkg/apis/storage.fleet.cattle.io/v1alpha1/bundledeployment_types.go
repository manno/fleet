...
// BundleRef is a reference to a bundle.
...
// OverwrittenResource indicates a resource that is overwritten by another bundle.
...
// BundleHelmOptions contains helm options for downloading a bundle from a helm repository.
