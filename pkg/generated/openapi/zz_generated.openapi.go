...
func schema_pkg_apis_fleetcattleio_v1alpha1_BundleDeployment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_fleetcattleio_v1alpha1_BundleDeploymentList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/rancher/fleet/pkg/apis/fleet.cattle.io/v1alpha1.BundleDeployment"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/rancher/fleet/pkg/apis/fleet.cattle.io/v1alpha1.BundleDeployment", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
