...
require (
  ...
  k8s.io/kube-controller-manager v0.24.2
  k8s.io/kube-proxy v0.24.2
  k8s.io/kube-scheduler v0.24.2
  ...
  k8s.io/sample-apiserver v0.24.2
...
replace k8s.io/client-go => github.com/manno/client-go v0.24.0-fleet2

replace helm.sh/helm/v3 => github.com/manno/helm/v3 v3.9.0-fleet1
